use super::allocated_nonnative_field_var::AllocatedEmulatedFpVar;
use ark_ff::{BigInteger, PrimeField};
use ark_r1cs_std::{
    boolean::Boolean,
    ToConstraintFieldGadget,
    bits::{ToBitsGadget, ToBytesGadget},
    fields::{nonnative::NonNativeFieldMulResultVar, fp::FpVar, FieldVar},
    impl_bounded_ops,
    prelude::*,
    R1CSVar,
};
...
impl<TargetF: PrimeField, BaseF: PrimeField> EmulatedFpVar<TargetF, BaseF> {
    ...
    pub fn mul_without_reduce(&self, other: &Self) -> R1CSResult<NonNativeFieldMulResultVar<TargetF, BaseF>> {
        unimplemented!()
    }
}
